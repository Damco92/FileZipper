...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.insertElement = function (element, paragraphFormat) {
        ...
        if (selection.start.paragraph.isEmpty()) {
            ...
            var bidi = (selection.start.paragraph.paragraphFormat.bidi) ? true : (paragraph && paragraphFormat.bidi) ? true : false;
    ...
    Editor.prototype.changeCaseParagraph = function (para, selection, startPos, endPos, property, isRevert) {
        ...
        for (var i = startLine; i <= endLine; i++) {
            ...
            var textCount = 0;
            var isBidi = line.paragraph.paragraphFormat.bidi;
            var isLineContainsRtl = this.documentHelper.layout.isContainsRtl(line);
            var isIterationStarted = true;
            var endElementBox = undefined;
            var childIndex = -1;
            var isIncreaseIteration = true;
            /* eslint-disable-next-line max-len */
            for (var j = !isBidi ? 0 : line.children.length - 1; !isBidi ? j < line.children.length : j >= 0; isBidi ? j-- : isIncreaseIteration ? j++ : j--) {
        ...
        if (!para.bidi && this.documentHelper.layout.isContainsRtl(para.childWidgets[startLine])) {
     ...
     * @returns {void}
     */
    Editor.prototype.removeBlock = function (block, isSkipShifting, skipComment) {
        var index;
        var blockCollection;
        var containerWidget;
        ...
        if (block.isInsideTable) {
            ...
            if (!this.owner.enableTrackChanges || this.editorHistory.isUndoing || this.editorHistory.isRedoing) {
                this.updateNextBlocksIndex(block, false);
    ...
    Editor.prototype.removePrevParaMarkRevision = function (currentBlock, moveNext) {
        ...
        if (this.owner.enableTrackChanges) {
            ...
            if (!currentPara.isEmpty()) {
                ...
                if (moveNext && !isNullOrUndefined(nonEmptyEndPara.nextRenderedWidget)) {
                    nonEmptyEndPara = nonEmptyEndPara.nextRenderedWidget;
                    i++;
                }
            }
            if (!moveNext) {
            ...
            var lineW = nonEmptyEndPara.childWidgets[0];
            if (!isNullOrUndefined(lineW) && lineW.children.length > 0) {
                var firstTextBox = lineW.children[0];
                    ...
                    for (var k = 0; k < cell_1.childWidgets.length; k++) {
                        ...
                        for (var l = 0; l < para.childWidgets.length; l++) {
                            ...
                            if (block instanceof LineWidget) {
                                var line = block;
                                for (var j_1 = 0; j_1 < line.children.length; j_1++) {
                                    var element = line.children[j_1];
                                    if (element instanceof FootnoteElementBox) {
                                        this.removeFootnote(element);
                                    }
                                }
    ...
    Editor.prototype.deleteCell = function (cell, selection, editAction, copyChildToClipboard) {
        ...
        for (var j = 0; j < bookmarkCollection.length; j++) {
            cell.childWidgets[0].childWidgets[0].children.push(bookmarkCollection[j]);
            cell.childWidgets[0].childWidgets[0].children.push(bookmarkCollection[j].reference);
            bookmarkCollection[j].line = cell.childWidgets[0].childWidgets[0];
            bookmarkCollection[j].reference.line = cell.childWidgets[0].childWidgets[0];
            this.documentHelper.bookmarks.add(bookmarkCollection[j].name, bookmarkCollection[j]);
        }
        return true;
    };
